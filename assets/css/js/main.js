(function () {
    ...
    if (form) {
        form.addEventListener("submit", (e) => {
            ...
            // If you have a backend later, submit there.
            // For now, we open WhatsApp with the message (fast + works in Botswana).
            const text =
    ...
    // ===== Update quick-action buttons (optional, if you change numbers) =====
